...
| 3 | AI provider | All via litellm; default Ollama in Docker |
...
│  │                                                            │ │
│  │  ┌────────────┐ ┌─────────────┐ ┌───────────────────────┐ │ │
│  │  │ SimpleFin  │ │ CSV Ingest  │ │ AI Agent (litellm)    │ │ │
...
│   │   ├── categorizer.py         # AI-first + rule fallback
│   │   ├── dedup.py               # SHA256 hash dedup
